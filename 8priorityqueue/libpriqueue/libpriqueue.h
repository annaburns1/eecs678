...
{
// helper linked list structure that can be a field
// want to store a compare function that takes any two elements (void pointers) produces int value that is the comparison
  int size;
  struct _node *head;
