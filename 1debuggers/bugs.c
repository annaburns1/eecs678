...
void echoohce(char** strs) {
  ...
  //had to dereference the iter variable so that it would print the word
  ...
  // wrong.
  // used the stop beginning variable to halt for loop instead of NULL value
...
int main(int argc, char** argv) {
  ...
  //moved this so it is before the print instead of after
  ...
  //added to the echo function will halt
  ...
  // Free all duplicated strings AFTER all calls to them have been made
  // (had to move this)
  ...
  //changed to 6 so that it returns null
